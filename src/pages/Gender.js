    ...
    <>
      ...
      <div className="main-container">
        ...
        <div className="gender-button">
          <button type="button" className="main-button" onClick={() => handleGenderSelect('여자')}>여자</button>
          <button type="button" className="main-button" onClick={() => handleGenderSelect('남자')}>남자</button>
        </div>
        </div>
      </div>
    </>
